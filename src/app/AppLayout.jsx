      ...
      <MotionConfig reducedMotion="user">
        <div className="min-h-dvh flex flex-col bg-background transition-colors duration-300 overflow-x-hidden">
          ...
          <div className="lg:pl-[var(--sidebar-width)] flex-1 flex flex-col min-h-0">
            ...
            <main id="main-content" tabIndex={-1} className="flex-1 flex flex-col pt-(--header-height) overflow-x-hidden overflow-y-auto lg:overflow-y-auto focus:outline-none">
              ...
              <m.div
                ...
                className="flex-1 w-full content-wide px-responsive py-responsive flex flex-col min-h-0 gap-(--panel-gap)"
              >
                <Outlet />
              </m.div>
            </main>
