...
function Help() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Zephyr stores all data locally on your device—we don't have access to your data. Currently, there's no automatic cloud backup. To back up your data, you can manually export your notes using the Import/Export buttons on the Notes page. We recommend regularly exporting important information if you want to preserve it. Cloud sync and automatic backup features may be available in future updates.",
      icon: Cloud,
      iconColor: "text-primary",
      bgColor: "bg-accent/60"
    },
    {
      ...
      answer: "To clear all your data, go to Settings > Data Management. Click the 'Clear All Local Storage' button. You'll be asked to confirm this action as it permanently deletes all tasks, events, notes, timer sessions, settings, and preferences. This action cannot be undone and will reload the page. Make sure to export any important data before clearing if needed.",
      icon: Trash2,
        ...
        <div className="flex-1 min-h-0 overflow-y-auto space-y-3 sm:space-y-4">
          <Card className="border border-border/60 bg-card/90 rounded-2xl shadow-sm">
            ...
            <CardContent className="space-y-4 sm:space-y-6 text-xs sm:text-sm text-muted-foreground">
              <div>
                <p className="text-xs sm:text-sm text-muted-foreground mb-4">Last updated: {new Date().toLocaleDateString()}</p>
                ...
                <p>
                  If you have questions about this Privacy Policy, please contact us at: <a href="mailto:dominik.koenitzer@gmail.com" className="text-primary hover:underline">dominik.koenitzer@gmail.com</a>
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border border-border/60 bg-card/90 rounded-2xl shadow-sm">
            ...
            <CardContent className="space-y-4 sm:space-y-6 text-xs sm:text-sm text-muted-foreground">
              <div>
                ...
                <p>
                  For questions about these Terms of Service, please contact us at: <a href="mailto:dominik.koenitzer@gmail.com" className="text-primary hover:underline">dominik.koenitzer@gmail.com</a>
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border border-border/60 bg-card/90 rounded-2xl shadow-sm">
            ...
            <CardContent className="space-y-4 sm:space-y-6 text-xs sm:text-sm text-muted-foreground">
              <div>
                ...
                <p>
                  For legal inquiries or questions about these terms, please contact us at: <a href="mailto:dominik.koenitzer@gmail.com" className="text-primary hover:underline">dominik.koenitzer@gmail.com</a>
                </p>
              </div>
            </CardContent>
          </Card>
