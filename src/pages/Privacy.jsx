        ...
        <Card className="">
          ...
          <CardContent className="space-y-4 sm:space-y-6 text-xs sm:text-sm text-muted-foreground">
            <div>
              ...
              <p>
                If you have questions about this Privacy Policy, please contact us at: <a href="https://github.com/dominikkoenitzer/Zephyr/issues" className="text-primary underline underline-offset-4">GitHub</a>
              </p>
            </div>
          </CardContent>
        </Card>
